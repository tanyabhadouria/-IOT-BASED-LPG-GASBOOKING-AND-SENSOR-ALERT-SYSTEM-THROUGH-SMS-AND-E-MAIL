...
<h3>  IOT Based LPG GAS Booking & Sensor Alert System [ SMS / E-MAIL ]  </h3>
</td>
</tr>
</table>
</div>
...
{
if($_REQUEST['user'] == "iotlpg" && $_REQUEST['pwd'] == "iotlpg456")
{
$_SESSION['user'] = array("username" => "iotlpg", "password" => "iotlpg456");
